import '../../public/Styles/Cliente_table.css'
function Clientes_table() {
  ...
  <tbody>
    <tr>
      ...
      <td className="foto-td" style={{paddingLeft: "0px"}}><img src="https://www.geoconstructor.cl/wp-content/uploads/2022/10/3664.jpg" width={'50px'}/></td>
      <td>809-715-1515</td>
      <td>Santo Domingo</td>
      <td>
        <button className="btn btn-warning me-1 pt-0 px-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
