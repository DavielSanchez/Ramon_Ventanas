...
function Cobros_pendientes_table() {
  return (
    <>
    <h2 style={{ textAlign: "center" }}>Cobros pendientes</h2>
    ...
    <tr>
        ...
        <td>
            ...
            <button className="btn btn-outline-warning pt-0 px-2">
...
export default Cobros_pendientes_table