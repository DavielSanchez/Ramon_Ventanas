...
export default Inventario_table
  ...
  {/* {datos.map(dato => (
          <div className="box" key={dato.carId}>
            <img className='img-fluid' src={dato.carImagePng}/>
            <h3>{dato.carBrand} {dato.carModel} {dato.carYear}</h3>
            <div className="details">
              <span>USD$ {new Intl.NumberFormat().format(dato.carPrice)}</span>
              <Link className='link'
      to={{
