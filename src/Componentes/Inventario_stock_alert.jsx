...
function Inventario_stock_alert() {
  return (
    <>
    <h2 style={{ textAlign: "center" }}>Alerta de Stock</h2>
    <div className="stock_table overflow-auto">
        <table className="table table-sm mt-5 table-hover table-responsive">
    <thead>
        <tr>
        <th scope="col">#</th>
        <th scope="col">Nombre</th>
        <th scope="col">Stock act.</th>
...
export default Inventario_stock_alert